...
For our method, we choose simple neural networks and prove it is useful to solve integral equations. And we suppose the bi-level algorithm which is shown in ![image](https://github.com/liuqs111/DNA-SE/blob/main/figure_DNA-SE.pdf).
